// File: Linked_list_sequential.h
// Author: Ikaro Costa
// Date: 11/13/2016
// Header file for a Doubly linked list to be parallelized in the future.

#ifndef LINKED_LIST_SEQUENTIAL_H
#define LINKED_LIST_SEQUENTIAL_H
...
template<typename T>
class Linked_list_sequential
{
	public:

	// Constructor and Destructor.
	Linked_list_sequential();
	~Linked_list_sequential();
...
#include "Linked_list_sequential.hpp"

#endif // LINKED_LIST_SEQUENTIAL_H
